...
public class AdminProfilePanel extends JPanel {
	...
	public AdminProfilePanel() {
		...
		JLabel lblUniversityName = new JLabel("Collage Name  :  ");
		lblUniversityName.setHorizontalAlignment(SwingConstants.RIGHT);
		lblUniversityName.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		lblUniversityName.setBorder(new LineBorder(Color.LIGHT_GRAY));
		lblUniversityName.setBounds(233, 213, 191, 48);
		add(lblUniversityName);
		
		JLabel universitynamelable = new JLabel("  "+a.getUniversityName());
		universitynamelable.setToolTipText(a.getUniversityName());
		universitynamelable.setHorizontalAlignment(SwingConstants.LEFT);
		universitynamelable.setFont(new Font("Segoe UI Semibold", Font.BOLD, 20));
		universitynamelable.setBorder(new LineBorder(Color.LIGHT_GRAY));
		universitynamelable.setBounds(423, 213, 672, 48);
		add(universitynamelable);
