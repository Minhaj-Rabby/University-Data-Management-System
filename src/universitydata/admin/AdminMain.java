...
import universitydata.common.UsersPanel;
import universitydata.department.DepartmentPanel;
...
import universitydata.student.PenddingStudentPanel;
...
import universitydata.teacher.PenddingTeacherPanel;
...
public class AdminMain extends JFrame  implements ActionListener
{
	...
	private JButton penndingteachersbutton;
	private JButton penddingstudentsbutton;
	...
	public PenddingStudentPanel studentpanel2 ;
	...
	public PenddingTeacherPanel teacherpanel2;
...
//					int result=new AdminData().setActiveStatus(a.getActiveStatus());
		...
		this.setBounds(-2,0,1370,733);
		 ...
		 universitynamelabel.setHorizontalAlignment(SwingConstants.LEFT);
		 universitynamelabel.setFont(new Font("Tw Cen MT", Font.BOLD, 25));
		 universitynamelabel.setBackground(Color.DARK_GRAY);
		 universitynamelabel.setText("Adminstrator");
		 universitynamelabel.setOpaque(true);
		 universitynamelabel.setBounds(65, 5, 171, 36);
		 profilepanel.add(universitynamelabel);
		...
		departmentbutton = createButton("Departments");
		sidebarpanel.add(departmentbutton);
		
		studentsbutton =createButton("Students");
		sidebarpanel.add(studentsbutton);
		
		penddingstudentsbutton =createButton("Pendding Students");
		sidebarpanel.add(penddingstudentsbutton);
		...
		penndingteachersbutton = createButton("Pennding Teachers");
		sidebarpanel.add(penndingteachersbutton);
	...
	public void disablepanel()
	{
		...
		else if(studentpanel2!=null&&studentpanel2.isVisible())
		{
			studentpanel2.setVisible(false);
		}
		...
		else if(teacherpanel2!=null && teacherpanel2.isVisible())
		{
			teacherpanel2.setVisible(false);
		}
	...
	public void openPanel(Object source) 
	{
		...
		else if(source==penddingstudentsbutton)
		{
			activeButton(penddingstudentsbutton);
			studentpanel2=new PenddingStudentPanel(this);
			studentpanel2.setLocation(panelx,panely);
			studentpanel2.setVisible(true);
			studentpanel2.setFocusable(true);
			contentPane.add(studentpanel2);
		...
		else if(source==penndingteachersbutton)
		{
			activeButton(penndingteachersbutton);
			teacherpanel2=new PenddingTeacherPanel(this);
			teacherpanel2.setLocation(panelx,panely);
			teacherpanel2.setVisible(true);
			teacherpanel2.setFocusable(true);
			contentPane.add(teacherpanel2);
