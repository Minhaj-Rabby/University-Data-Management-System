...
import universitydata.common.ScrollPaneUtil;
...
public class DepartmentPanel extends JPanel implements ActionListener {
	...
	public DepartmentPanel() {
		...
		JLabel allDepartmentslbl = new JLabel("All Departments");
		allDepartmentslbl.setForeground(new Color(255, 255, 255));
		allDepartmentslbl.setFont(new Font("Segoe UI", Font.BOLD, 30));
		allDepartmentslbl.setBounds(10, 65, 321, 34);
		panel.add(allDepartmentslbl);

		adddepartment = new JButton("Add Department");
		adddepartment.setBounds(939, 135, 147, 33);
		panel.add(adddepartment);
		adddepartment.setBorder(new EmptyBorder(0, 0, 0, 0));
		adddepartment.setForeground(new Color(0, 139, 139));
		adddepartment.setBackground(new Color(255, 255, 255));
		adddepartment.setFocusable(false);
		adddepartment.setCursor(new Cursor(Cursor.HAND_CURSOR));
		adddepartment.addActionListener(this);
		adddepartment.setFont(new Font("Segoe UI", Font.BOLD, 15));
	...
	public void updatetableData() {
		...
		table.getColumnModel().getColumn(1).setHeaderValue("Department Code");
		table.getColumnModel().getColumn(2).setMaxWidth(400);
		table.getColumnModel().getColumn(2).setHeaderValue("Department Name");
