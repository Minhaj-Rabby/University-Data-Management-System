 ...
 * Purpose : Displaying all the teacher with assigned subject
 */
...
public class AssignSubjectPanel extends JPanel {
	...
	public AssignSubjectPanel(TeacherMain fm)
	{
		this();
		condition=" where departmentcode='"+fm.f.getDepartmentCode()+"' and semoryear="+fm.f.getSemorYear()+" ";
	...
	private AssignSubjectPanel() {
		...
		JLabel allfaculitieslabel = new JLabel(" Assign Subject and Teachers");
		allfaculitieslabel.setIcon(null);
		allfaculitieslabel.setBounds(10, 65, 421, 44);
...
//				table.setEnabled(false);
	...
	{
		ResultSet rs=new TeacherData().getTeacherSubjectInfo(condition);
